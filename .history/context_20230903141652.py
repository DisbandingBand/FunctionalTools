...
'VERSION:2.0',
'X-WR-CALNAME:个人',
'PRODID:-//Apple Inc.//macOS 11.0//EN',
...
f.close() 
————————————————
版权声明：本文为CSDN博主「MarveleE」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/MarveleE/article/details/109313290